...
import DraftStyle from './DraftJsRichEditorExample.css';
...
class DraftJsRichEditorExample extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={DraftStyle["RichEditor-root"]}>
        <div className={DraftStyle["RichEditor-controls-container"]}>
          <BlockStyleControls
...
function StyleButton({active, style, label, onToggle}) {
  let classArray = [DraftStyle['RichEditor-styleButton']];
  if (active) {
    classArray.push(DraftStyle['RichEditor-activeButton']);
  }
  console.log(classNames(classArray))
  return (
    <span
...
function BlockStyleControls(props) {
  ...
  return (
    <div className={DraftStyle["RichEditor-controls"]}>
